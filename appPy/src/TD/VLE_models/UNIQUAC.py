...
def UNIQUAC13(x_1, T, q_1, q_2, r_1, r_2, a_12, a_21, b_12, b_21, c_12, c_21, d_12, d_21, e):
    """
    ...
    e (float): symmetrical binary interaction parameter [K^-2]
    """
    x_2 = 1 - x_1
...
UNIQUAC13_params_names = [
    'r_1', 'q_1', 'r_2', 'q_2', 'a_12', 'a_21', 'b_12', 'b_21', 'c_12', 'c_21', 'd_12', 'd_21', 'e'
]
UNIQUAC13_params_labels = UNIQUAC13_params_names
UNIQUAC_always_const = ['r_1', 'q_1', 'r_2', 'q_2']
...
UNIQUAC_model = VLE_Model(
    ...
    param_labels=UNIQUAC13_params_labels[:8],
...
UNIQUAC13_model = VLE_Model(
    ...
    param_labels=UNIQUAC13_params_labels,
    always_const_param_names=UNIQUAC_always_const,
    is_gamma_T_fun=True,
)
