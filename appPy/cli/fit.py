...
def cli_fit():
    ...
    p = [9.98, 11.52, 14.39, 25.01, 25.95, 39.91, 40.05, 52.5, 60.41, 78.21, 89.63, 100.05]
    T = [363.95, 367.65, 373.55, 389.25, 390.25, 403.35, 403.55, 412.45, 417.15, 426.25, 431.25, 435.35]

    fv = Fit_Vapor('TOL', 'antoine', p, T, [14.5, -3500, -100])
    fv.optimize_p()
    fv.optimize_T_p()
    fv.report()

    # 363.95	435.35
    # 15.262249	-4275.84	-34.083
