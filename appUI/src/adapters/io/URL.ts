// note that only origins listed in /appUI/electron/config.ts are allowed for navigation (does not apply for XHR requests)
...
export const REMOTE_PACKAGE_JSON_URL =
    'https://raw.githubusercontent.com/Lemonexe/VLizard/refs/heads/master/appUI/package.json';
